...
//Load Room Material from Assets
export default class Room {
    ...
    //Load Room Material base on name
    setModel() {
    ...
    //Rotate Room horizontally based on mouse moment
    onMouseMove() {
    ...
    //Sort Room object in numeric Order for grouping/loading
    ...
    //update room rotation based on mouse movement
    update() {
